...
import { readConfig, getFirstProject, addProject, projectBaseDir, workerStatus } from "./config-writer.mjs";
...
test("addProject: onStart/onReview status names are overridable", () => {
	const { configPath } = scratch();
	addProject(configPath, {
		id: "myrepo",
		repo: "owner/myrepo",
		path: "/data/projects/myrepo",
		teamId: "T1",
		startStatusName: "Doing",
